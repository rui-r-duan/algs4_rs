...
///
/// This implementation uses a singly linked list.  See `VecBag` for a version that is uses a
/// resizing Vec.  `VecBag` is similar to algs4 Java version `ResizingArrayBag`.
///
